...
namespace Morpe
{
    ...
    public class Polynomial
    {
        ...
        /// </summary>
        /// <param name="fullPolynomial">The fullspace polynomial.</param>
        /// <param name="subPolynomial">The subspace polynomial.</param>
        ...
        /// <summary>
        /// The number of inhomogeneous polynomial coefficients.  Also, the number of rows of <see cref="Polynomial.Coeffs"/> .
        /// </summary>
        ...
        /// </summary>
        /// <param name="numDims"><see cref="NumDims"/>.</param>
        /// <param name="rank"><see cref="Polynomial.Rank"/>.</param>
        public Polynomial(int numDims, int rank)
        {
            if (numDims < 1)
        ...
        {
            Polynomial output = this.MemberwiseClone() as Polynomial;
